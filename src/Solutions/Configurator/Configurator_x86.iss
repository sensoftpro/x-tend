...
#define MyBinDir "..\..\..\bin"
#define MyBuildDir MyBinDir + "\Win32"
...
OutputBaseFilename=setup_{#MyLowerCaseAppName}_x86_{#MyAppVersion}
...
[Dirs]
Name: "{app}\Win32"; Permissions: users-modify; Flags: uninsalwaysuninstall
...
[Files]
Source: "{#MyBuildDir}\{#MyAppExeName}"; DestDir: "{app}\Win32"; DestName: {#MyAppExeName}; Flags: ignoreversion sign
Source: "{#MyBuildDir}\ssleay32.dll"; DestDir: "{app}\Win32"; Flags: ignoreversion
Source: "{#MyBuildDir}\libeay32.dll"; DestDir: "{app}\Win32"; Flags: ignoreversion
Source: "{#MyBuildDir}\sqlite3.dll"; DestDir: "{app}\Win32"; Flags: ignoreversion
...
[Run]
Filename: "{app}\Win32\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppTitle, '&', '&&')}}"; Flags: postinstall
